...
size_of_numerical_window_ocu= 2e-3; % *CODE MISSING*
...
size_of_numerical_window_eyelens= 1.99e-3; % (this is for the telescope simulation, a 
...
for point_source_number=1:number_of_point_sources_in_simulation % one point source at a time
    ...
    r_center= 2e-2; % distance from point source to the origin (0,0) in the plane of the objective lens *CODE MISSING*
